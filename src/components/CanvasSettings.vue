...
import { Scene,WebGLRenderer,PointLight,MeshStandardMaterial,DoubleSide,AmbientLight } from "three";
...
import { lightIntensity, getMeshView} from "./three/globalsSettings.js"
import { objBlob,make,getLen, getThickness, getSupport, getTriangleSize, getFactor } from "../dist/stlGenerator"
...
make(0.4, 10, "test", false, false, false, 0.2, 1);

//generateOBJ lädt die ./assets/model.obj Datei. Muss auch zum neuladen des Obj aufgerufen werden
function generateOBJ() {
    make(getThickness(), getLen(), "test", false, getMeshView(), getSupport(), getTriangleSize(), getFactor());
    
    let material = new MeshStandardMaterial({
        color: 'white', 
        side: DoubleSide, 
        //wireframe stellt die Meshview ein
        wireframe: getMeshView(),
