...
//Einstellungen
var TRIANGLE_COUNT  :number;      //= 4000;
var ARRAY_SIZE      :number;      //= TRIANGLE_COUNT * 2;
var THICKNESS       :number;      //= 0.8;
...
export function make(th: number, l: number, name: string, save: boolean, wireframe: boolean, supports: boolean, triangleSize: number, factor: number) {
    stlBlob = "";
    objBlob = "";
